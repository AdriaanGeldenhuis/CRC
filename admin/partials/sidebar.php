...
<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="/admin/" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'index.php' && strpos($_SERVER['REQUEST_URI'], '/admin/') !== false && strpos($_SERVER['REQUEST_URI'], '/admin_congregation/') === false ? 'active' : '' ?>">
        ...
        <a href="/admin/news.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'news.php' ? 'active' : '' ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="/admin/congregations.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'congregations.php' ? 'active' : '' ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="/admin/sermons.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'sermons.php' ? 'active' : '' ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="/admin/content.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'content.php' ? 'active' : '' ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
