...
<head>
    ...
    <style>
        ...
        .filter-tab { padding: 0.5rem 1rem; background: var(--card); border: 1px solid var(--line); border-radius: var(--radius-sm); cursor: pointer; font-size: 0.875rem; color: var(--muted); transition: all 0.2s ease; text-decoration: none; }
        ...
        .event-card { background: var(--bg-glass); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border: 1px solid var(--line); border-radius: var(--radius); box-shadow: var(--shadow); overflow: hidden; display: flex; transition: all 0.2s ease; }
        .event-card:hover { border-color: var(--accent); }
        .event-date-box { background: linear-gradient(135deg, var(--accent) 0%, var(--accent2) 100%); color: white; padding: 1rem; display: flex; flex-direction: column; align-items: center; justify-content: center; min-width: 80px; }
        ...
        .event-title { font-weight: 600; color: var(--text); font-size: 1rem; }
        .event-status { font-size: 0.7rem; padding: 0.2rem 0.5rem; border-radius: 100px; }
        .event-status.published { background: rgba(34, 197, 94, 0.15); color: var(--good); }
        .event-status.draft { background: rgba(245, 158, 11, 0.15); color: var(--warn); }
        .event-status.cancelled { background: rgba(239, 68, 68, 0.15); color: var(--bad); }
        .event-meta { display: flex; gap: 1rem; font-size: 0.8rem; color: var(--muted); margin-bottom: 0.75rem; flex-wrap: wrap; }
        .event-meta-item { display: flex; align-items: center; gap: 0.375rem; }
        .event-meta-item svg { width: 14px; height: 14px; }
        .event-description { font-size: 0.875rem; color: var(--muted); line-height: 1.5; margin-bottom: 0.75rem; flex: 1; }
        .event-footer { display: flex; justify-content: space-between; align-items: center; padding-top: 0.75rem; border-top: 1px solid var(--line); }
        .event-stats { font-size: 0.8rem; color: var(--muted); }
        .event-actions { display: flex; gap: 0.5rem; }

        .modal { position: fixed; inset: 0; background: rgba(0,0,0,0.7); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); display: none; align-items: center; justify-content: center; z-index: 1000; overflow-y: auto; }
        .modal.show { display: flex; }
        .modal-content { background: var(--bg1); border: 1px solid var(--line); border-radius: var(--radius); padding: 1.5rem; max-width: 600px; width: 90%; margin: 2rem; box-shadow: var(--shadow-lg); }
        .modal-header { font-weight: 600; margin-bottom: 1rem; font-size: 1.1rem; color: var(--text); }
        .modal-body { margin-bottom: 1.5rem; max-height: 60vh; overflow-y: auto; color: var(--muted); }
