...
<head>
    ...
    <style>
        ...
        .settings-section { background: var(--bg-glass); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); border: 1px solid var(--line); border-radius: var(--radius); box-shadow: var(--shadow); }
        .settings-header { padding: 1.25rem 1.5rem; border-bottom: 1px solid var(--line); }
        .settings-header h2 { font-size: 1rem; font-weight: 600; color: var(--text); margin: 0; }
        .settings-header p { font-size: 0.8rem; color: var(--muted); margin: 0.25rem 0 0; }
